package com.shopx.billing.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> entityNotFound(ProductException pnf,WebRequest wr){
        return buildResponse(HttpStatus.NOT_ACCEPTABLE,pnf.getMessage());
    }
